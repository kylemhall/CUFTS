...
cufts_cjdb_create.pl [options] model|view|controller name [helper] [options]
 ...
 Examples:
   ...
   cufts_cjdb_create.pl -mechanize controller My::Controller
   ...
   cufts_cjdb_create.pl model SomeDB DBIC::Schema MyApp::Schema create=dynamic\
   dbi:SQLite:/tmp/my.db
   cufts_cjdb_create.pl model AnotherDB DBIC::Schema MyApp::Schema create=static\
