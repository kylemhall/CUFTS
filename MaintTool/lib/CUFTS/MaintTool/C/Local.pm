...
my $form_validate_local = {
	...
	optional => [
		...
		# Resource details...
		'resource_identifier', 'database_url', 'auth_name', 'auth_password', 'url_base', 'notes_for_local', 'cjdb_note'
	],
	defaults => {
		'active' => 'false',
		'proxy' => 'false',
...
my $form_validate_global = {
	optional => [
		...
		# Resource details...
		'resource_identifier', 'database_url', 'auth_name', 'auth_password', 'url_base', 'cjdb_note'
	],
	defaults => {
		'active' => 'false',
		'proxy' => 'false',
