## CUFTS::Resources::Dekker
##
## Copyright Michelle Gauther (based on code by Todd Holbrook) - Simon Fraser University (2004)
##
...
package CUFTS::Resources::Dekker;
...
sub build_linkJournal {
		...
		my $url = $urlbase . 'productid/' . $record->db_identifier . '/toc';
...
sub build_linkDatabase {   
        ...
        foreach my $record (@$records) {
                ...
                $result->url('http://www.dekker.com/catalog/search.jsp');
                $result->record($record);
